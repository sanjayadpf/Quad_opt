...
import rospy
from fullurdf2.srv import SetStiffness, SetStiffnessRequest
import time
...
def change_stiffness():
    ...
    for joint_index in range(2, 51):
        ...
        rospy.loginfo(f"Calling /gazebo/set_joint_stiffness_fullurdf2 service for {joint_name} with stiffness {stiffness_value}")
